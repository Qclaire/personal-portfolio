...
const HeroSection = () => {
    ...
    const commands = [
        ...
        {
            cmd: "uname -a",
            result: "DevOps Pro Kernel v4.2 OSG #1 SMP Continuous Delivery",
        },
        {
            cmd: "ls ~/skills",
            result: "python/  django/  terraform/  kubernetes/  aws/  docker/  jenkins/  ansible/  prometheus/  grafana/",
        },
        {
            cmd: "cat ~/about.txt",
            result: "Hi, I'm Oswald - I automate deployments by day and debug mysterious production issues by night.\nTurning coffee into infrastructure code since 2015.\nSpecialist in making machines do what humans should never have to.",
        },
        {
            cmd: "ps aux | grep hobbies",
            result: "oswald    1337  5.0  3.8  gaming\noswald    2468 10.5  2.3  cooking\noswald    3579  8.2  4.5  tinkering-hardware\noswald    4680  7.1  3.2  reading-tech-blogs",
        },
        {
            cmd: "df -h",
        ...
        const smartAutoScroll = () => {
            ...
            if (terminalContent && !isUserScrolling) {
                const { scrollTop, scrollHeight, clientHeight } =
                    terminalContent;
                const isAtBottom =
                    scrollTop + clientHeight >= scrollHeight - 10; // 10px tolerance
                    ...
                    addTimeout(() => {
                        ...
                        const typeNextResultLine = () => {
                            if (lineIndex < resultLines.length) {
                                typeResult(resultLines[lineIndex], () => {
                                    lineIndex++;
                                    if (lineIndex < resultLines.length) {
    ...
    return (
        ...
        >
            ...
            <div
                className={`max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full transition-all duration-1000 ${
                    loaded
                    ...
                    <div className="w-full max-w-4xl mx-auto relative">
                        <div className="terminal-window bg-black rounded-lg shadow-2xl border border-green-400 border-opacity-30 overflow-hidden">
                            ...
                            <div className="terminal-header flex items-center bg-black px-4 py-2 border-b border-green-400 border-opacity-20">
                                ...
                                <div className="text-center flex-1 text-sm text-green-400">
                                    oswald@devops:~/portfolio
                                </div>
                            </div>
                            ...
                            <div className="terminal-content p-4 font-mono text-sm h-96 overflow-y-auto bg-black">
                                <div className="text-green-400 mb-2">
                                    # Welcome to Oswald's DevOps Terminal
                                </div>
                                ...
                                {!currentCommand &&
                                    terminalLines.length ===
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-green-400 cursor-blink">
                                                _
                                            </span>
                                        </div>
                                    )}
                            ...
                            {isUserScrolling && (
                                <div
                                    className="absolute bottom-2 right-2 bg-green-400 text-black px-2 py-1 rounded text-xs animate-pulse cursor-pointer"
                                    onClick={() => {
