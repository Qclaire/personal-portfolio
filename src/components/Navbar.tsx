...
const Navbar = () => {
    ...
    return (
        <nav
            className={`fixed w-full z-50 top-0 left-0 transition-all duration-300 backdrop-blur-md ${
                isScrolled
                    ? "bg-opacity-80 bg-background py-2"
                    : "bg-transparent py-4"
            }`}
        >
                    ...
                    <div className="hidden md:flex items-center space-x-1">
                        <div className="nav-orbs flex space-x-3 bg-opacity-20 bg-splash px-6 py-3 rounded-full">
                            {navItems.map((item, index) => (
                                ...
                                >
                                    <div
                                        className={`orb-icon text-xl mb-1 transition-all duration-300 transform ${
                                            activeSection ===
