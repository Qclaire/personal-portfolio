            ...
            <div className="relative z-10">
                ...
                <div className="p-6">
                    <div className="terminal-like mb-6">
                        <div className="text-terminal-green text-sm mb-1">$ cat project_overview.md</div>
                    ...
                    {/* Technologies */}
                    <div className="text-terminal-green text-sm mb-1">$ ls ./technologies</div>
                    ...
                    {/* Actions */}
                    <div className="text-terminal-green text-sm mb-2">$ ./actions.sh</div>
    ...
    const projects = [
        {
            ...
            technologies: ["Kubernetes", "Istio", "Terraform", "ArgoCD", "AWS EKS"],
        ...
        },
        {
            ...
            technologies: ["AWS", "Terraform", "Python", "CloudWatch", "Grafana"],
        ...
        },
        {
            ...
            technologies: ["HashiCorp Vault", "AWS IAM", "OPA", "Kubernetes", "Terraform"],
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-16">
                    <div className="inline-block mb-4 px-4 py-1.5 bg-splash bg-opacity-20 backdrop-blur-sm rounded-full">
                        <span className="text-accent text-sm font-semibold">Infrastructure Deployments</span>
                    </div>
                    ...
                    <p className="mt-4 text-lg opacity-80 max-w-2xl mx-auto">
                        Highlighted below are key infrastructure and automation projects I've architected, showcasing scalable 
                        solutions that have transformed deployment workflows and driven significant business outcomes.
                    </p>
                </div>
